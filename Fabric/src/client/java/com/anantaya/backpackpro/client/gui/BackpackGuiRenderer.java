...
public final class BackpackGuiRenderer {
    ...
    private static void drawButton(
        ...
        switch (button.type) {
            ...
            case AUTO_PICKUP_MODE -> drawTinyFilterIcon(graphics, x, y);
            case AUTO_PICKUP_IGNORE_DROPS -> drawTinyDropIcon(graphics, x, y);
        }
    }
    ...
    public static void drawTrashSlot(
        ...
        // Same 18x18 slot frame style as normal slots
        ...
        // Inner slot background, not pure black
    ...
    private static void drawThinFloatingPanel(
        ...
        // Matches rest of backpack UI, but lighter than full section boxes
        ...
        // subtle inner background so it does not look isolated
        graphics.fill(x + 1, y + 1, x + w - 1, y + h - 1, tint);

        // vanilla-like top/left highlight
