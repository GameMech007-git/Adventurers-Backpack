...
import com.anantaya.backpackpro.network.BackpackTrashPayload;
import com.anantaya.backpackpro.network.FluidStoragePayload;
import com.anantaya.backpackpro.network.UpgradeConfigPayload;
    ...
    private static void drawExtraStorageTooltip(
        ...
        screen.showTooltip(
                ...
                List.of(
                        ...
                        Component.literal("Manual storage only"),
                        Component.literal("Automation and Sort ignore this panel")
                ),
                mouseX,
                mouseY
        );
