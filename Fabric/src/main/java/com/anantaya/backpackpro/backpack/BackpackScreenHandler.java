...
import com.anantaya.backpackpro.menu.BackpackSortHelper;
import com.anantaya.backpackpro.menu.BackpackTrashHelper;
import com.anantaya.backpackpro.registry.ModMenus;
import com.anantaya.backpackpro.upgrade.BackpackUpgradeConfigAction;
import com.anantaya.backpackpro.upgrade.BackpackUpgradeConfigDispatcher;
import com.anantaya.backpackpro.upgrade.BackpackUpgradeHelper;
import com.anantaya.backpackpro.upgrade.BackpackUpgradeItem;
import com.anantaya.backpackpro.upgrade.crafting.BackpackCraftingMenuHandler;
import com.anantaya.backpackpro.upgrade.extrastorage.BlockBackpackContainer;
import com.anantaya.backpackpro.upgrade.extrastorage.BlockExtraStorageContainer;
import com.anantaya.backpackpro.upgrade.extrastorage.ExtraStorageInventory;
import com.anantaya.backpackpro.upgrade.fluidstorage.BackpackFluidMenuHandler;
...
public class BackpackScreenHandler extends AbstractContainerMenu {
    ...
    public int craftingInputStart() {
        return transferHelper.craftingInputStart();
    }

    public int craftingInputEnd() {
        return transferHelper.craftingInputEnd();
    }

    public int craftingResultSlot() {
        return transferHelper.craftingResultSlot();
    }

    public int craftingEnd() {
        return transferHelper.craftingEnd();
    }
