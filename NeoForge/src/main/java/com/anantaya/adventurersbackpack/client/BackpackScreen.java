...
public class BackpackScreen extends AbstractContainerScreen<BackpackScreenHandler> {
    ...
    public BackpackScreen(
        ...
        System.out.println("[Backpack] BackpackScreen constructor fired");
        System.out.println("[Backpack] screen tier=" + handler.tier);
        System.out.println("[Backpack] slot count=" + handler.slots.size());
